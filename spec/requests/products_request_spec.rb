    ...
    describe "GET #show" do
      ...
      context "when invalid param" do
        ...
        it "should return error message" do
          expect(flash[:danger])
            .to eq I18n.t(".admins.products.destroy.unknown_product")
        end
      end
    end
      ...
      context "when valid param" do
        ...
        it "should return success message" do
          expect(flash[:success])
            .to eq I18n.t(".admins.products.create.product_created_success")
        end
      end
    ...
    describe "DELETE #destroy" do
      context "when valid param" do
        ...
        it "destroy product" do
          expect(assigns(:product).destroyed?).to eq true
        end

        it "show status 302" do
      ...
      context "when delete fail" do
        ...
        it "should return fail message" do
          expect(flash[:danger]).to eq I18n.t(".admins.products.destroy.product_delete_fail")
        end
